...
from oe_find_sds.find_sds import download_sds, download_sds_tci
...
# @pytest.mark.xfail   # May 10, 2020: cannot extract from new TCI website
...
# def test_download_sds_tci(tmpdir, monkeypatch, cas_nr, expect):
    ...
    # result = download_sds_tci(cas_nr)
